...
@section('title', 'Nouvelle réponse')

@section('content')
    <div class="max-w-2xl mx-auto">
        <h1 class="text-2xl font-bold text-gray-800 mb-6">Nouvelle réponse</h1>
            ...
            <form method="POST" action="{{ route('reponses.store') }}">
                ...
                <div class="mb-4">
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" name="est_correcte" value="1" {{ old('est_correcte') ? 'checked' : '' }}
