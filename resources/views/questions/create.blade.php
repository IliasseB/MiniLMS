...
@section('content')
    <div class="max-w-2xl mx-auto">
        <h1 class="text-2xl font-bold text-gray-800 mb-6">Nouvelle question</h1>
            ...
            <form method="POST" action="{{ route('questions.store') }}">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="question" rows="3"
                        class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-400">{{ old('question') }}</textarea>
                    @error('question')
